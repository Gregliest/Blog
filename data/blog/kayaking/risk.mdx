...
One thing that I have learned is that the quality of a decision cannot be measured by its outcome. Too often, I see someone have a terrible line, roll up at the bottom, and then claim that they made a good decision to run the rapid because they ended up ok. Or, someone has a good, but lucky line, and are blissfully unaware that they were flirting with disaster. In both cases the boater is probably taking on more risk than they realize. A decision can be judged only on the information and probabilities known at the time of the decision. While I learned this idea on the river, it turns out to be one of the fundamental rules of decision analysis, and is used widely in business and engineering.
