      ...
      Object.defineProperty(t, '__esModule', { value: !0 }),
        (t.default = function (e) {
          var t = e.src,
            ...
            D = d.useContext(m.ImageConfigContext),
            U = d.useMemo(
              function () {
                var e = y || D || f.imageConfigDefault,
                  t = a(e.deviceSizes)
          ...
          if (
            ...
            if (
              ...
              (T = J.src),
              (!F || 'fill' !== F) &&
                ((q = q || J.height), (L = L || J.width), !J.height || !J.width))
            )
              throw new Error(
          ...
          ;((t = 'string' === typeof t ? t : T).startsWith('data:') || t.startsWith('blob:')) &&
            ((c = !0), (Q = !1))
          b.has(t) && (Q = !1)
          U.unoptimized && (c = !0)
          var K,
            ...
            Y = X[0],
            $ = X[1],
            ee = o(g.useIntersection({ rootRef: E, rootMargin: I || '200px', disabled: !Q }), 3),
            te = ee[0],
            ie = ee[1],
            ne = ee[2],
            oe = !Q || ie,
          ...
          var pe = { src: v, srcSet: void 0, sizes: void 0 }
          oe &&
            (pe = S({
              config: U,
              src: t,
          ...
          var be,
            ve = 'imagesrcset',
            we = 'imagesizes'
          ;(ve = 'imageSrcSet'), (we = 'imageSizes')
          var ze =
              (n((be = {}), ve, pe.srcSet),
              n(be, we, pe.sizes),
              n(be, 'crossOrigin', V.crossOrigin),
              be),
          ...
          return d.default.createElement(
            ...
            d.default.createElement(
              ...
              le
                ...
                : null,
              d.default.createElement(j, Object.assign({}, ke))
            ),
            p
              ? d.default.createElement(
                  u.default,
        ...
        [
          ...
          function (e) {
            var t = e.config,
              i = e.src,
              n =
                ['f_auto', 'c_limit', 'w_' + e.width, 'q_' + (e.quality || 'auto')].join(',') + '/'
        ...
        e &&
          ...
          ('decode' in e ? e.decode() : Promise.resolve())
            ...
            .then(function () {
              if (
                e.parentNode &&
                (b.add(t), 'blur' === n && a(!0), null == o ? void 0 : o.current)
              ) {
          ...
          d.default.createElement(
            ...
            d.default.createElement(
              ...
              Object.assign({}, j, t, {
                ...
                ref: d.useCallback(
                  function (e) {
                    w(e), (null == e ? void 0 : e.complete) && k(e, m, 0, f, b, v)
                  },
                  [w, m, o, f, b, v]
                ),
                onLoad: function (e) {
              ...
              d.default.createElement(
                ...
                d.default.createElement(
                  ...
                  Object.assign(
                    ...
                    { decoding: 'async', 'data-nimg': o, style: l, className: a, loading: g }
                  )
                )
              )
          )
