;(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [195],
  {
    7478: function (u, D, F) {
      ...
      ;(n.prototype.slug = function (u, D) {
        ...
        let t = r(u, !0 === D)
        const n = t
        for (; e.call(F.occurrences, t); ) F.occurrences[n]++, (t = n + '-' + F.occurrences[n])
    ...
    2023: function (u, D, F) {
      ...
      function A(u) {
        return (0, e.tZ)(r.Z, {
          sx: [{ maxWidth: 340 }].concat((0, t.Z)(Array.isArray(u.sx) ? u.sx : [u.sx])),
          children: (0, e.BX)(a.Z, {
            component: 'a',
            href: '#',
            sx: { width: 1, height: 1 },
            children: [
              (0, e.tZ)(i.Z, { component: 'img', sx: { width: 1 }, image: u.post.image }),
              (0, e.BX)(C.Z, {
                sx: { flex: 1 },
                children: [
                  (0, e.tZ)(n.Z, { component: 'h2', variant: 'h5', children: u.post.title }),
                  (0, e.tZ)(n.Z, {
                    variant: 'subtitle1',
                    color: 'text.secondary',
                    children: (0, E.Z)(u.post.date),
                  }),
                  (0, e.tZ)(n.Z, { variant: 'subtitle1', paragraph: !0, children: u.post.summary }),
                ],
              }),
            ],
          }),
    ...
    1476: function (u, D, F) {
      ...
      var t = F(6690),
        ...
        i = function (u) {
          ...
          return (0, t.BX)(n(), {
            children: [
              ...
              (0, t.tZ)('meta', {
                property: 'og:url',
                content: ''.concat(C().siteUrl).concat(A.asPath),
              }),
              (0, t.tZ)('meta', { property: 'og:type', content: e }),
              (0, t.tZ)('meta', { property: 'og:site_name', content: C().title }),
              ...
              (0, t.tZ)('meta', { name: 'twitter:site', content: C().twitter }),
              (0, t.tZ)('meta', { name: 'twitter:title', content: D }),
              (0, t.tZ)('meta', { name: 'twitter:description', content: F }),
              (0, t.tZ)('meta', { name: 'twitter:image', content: i }),
              (0, t.tZ)('link', {
                rel: 'canonical',
                href: E || ''.concat(C().siteUrl).concat(A.asPath),
              }),
            ],
          })
        },
        ...
        A = function (u) {
          ...
          return (0, t.BX)(t.HY, {
            children: [
              (0, t.tZ)(i, { title: D, description: F, ogType: 'website', ogImage: e, twImage: a }),
              (0, t.tZ)(n(), {
                children: (0, t.tZ)('link', {
                  rel: 'alternate',
                  type: 'application/rss+xml',
                  title: ''.concat(F, ' - RSS feed'),
                  href: ''.concat(C().siteUrl).concat(E.asPath, '/feed.xml'),
                }),
              }),
            ],
          })
        ...
        o = function (u) {
          var D = u.authorDetails,
            ...
            o = void 0 === A ? [] : A,
            c = u.canonicalUrl,
            B = new Date(r).toISOString(),
            l = new Date(a || r).toISOString(),
            s = (0 === o.length ? [C().socialBanner] : 'string' === typeof o ? [o] : o).map(
              function (u) {
                return { '@type': 'ImageObject', url: ''.concat(C().siteUrl).concat(u) }
              }
            ),
            d = {
              '@context': 'https://schema.org',
              '@type': 'Article',
              mainEntityOfPage: { '@type': 'WebPage', '@id': E },
              headline: F,
              image: s,
              datePublished: B,
              dateModified: l,
          ...
          return (0, t.BX)(t.HY, {
            children: [
              ...
              (0, t.BX)(n(), {
                children: [
                  r && (0, t.tZ)('meta', { property: 'article:published_time', content: B }),
                  a && (0, t.tZ)('meta', { property: 'article:modified_time', content: l }),
                  (0, t.tZ)('script', {
                    type: 'application/ld+json',
                    dangerouslySetInnerHTML: { __html: JSON.stringify(d, null, 2) },
                  }),
                ],
              }),
            ],
        ...
        return (0, t.tZ)('div', {
          ...
          children: (0, t.BX)('nav', {
            ...
            children: [
              ...
              n &&
                (0, t.tZ)(e.Z, {
                  href: F - 1 === 1 ? '/blog/' : '/blog/page/'.concat(F - 1),
                  children: (0, t.tZ)('button', { children: 'Previous' }),
                }),
              (0, t.BX)('span', { children: [F, ' of ', D] }),
              !r &&
                (0, t.tZ)('button', {
                  className: 'cursor-auto disabled:opacity-50',
                  disabled: !r,
              ...
              r &&
                (0, t.tZ)(e.Z, {
                  href: '/blog/page/'.concat(F + 1),
                  children: (0, t.tZ)('button', { children: 'Next' }),
                }),
            ],
          }),
        })
        ...
        return (0, t.BX)(t.HY, {
          children: [
            ...
            A &&
              A.totalPages > 1 &&
              !c &&
              (0, t.tZ)(a, { currentPage: A.currentPage, totalPages: A.totalPages }),
          ],
        })
      }
    },
    ...
    4178: function (u, D, F) {
      ...
      function A(u) {
        ...
        return (0, t.BX)(t.HY, {
          children: [
            (0, t.tZ)(a.TQ, { title: 'Blog - '.concat(n().author), description: n().description }),
            (0, t.tZ)('div', {
              className: 'container py-12',
              children: (0, t.tZ)('div', {
                className: '-m-4 flex flex-wrap',
                children: e.map(function (u) {
                  return (0, t.tZ)(C.Z, { post: u }, u.title)
                }),
              }),
            }),
            (0, t.tZ)(r.default, {
  ...
  function (u) {
    u.O(0, [842, 242, 888, 774, 179], function () {
      return (D = 3986), u((u.s = D))
      var D
    })
    var D = u.O()
    _N_E = D
