                      ...
                      return (
                        ...
                        [
                          ...
                          fetch('/api/'.concat(i().newsletter.provider), {
                            body: JSON.stringify({ email: a.current.value }),
    ...
    1476: function (u, D, F) {
      ...
      var t = F(6690),
        ...
        C = function (u) {
          ...
          return (0, t.BX)(r(), {
            children: [
              ...
              (0, t.tZ)('meta', {
                property: 'og:url',
                content: ''.concat(i().siteUrl).concat(c.asPath),
              }),
              (0, t.tZ)('meta', { property: 'og:type', content: e }),
              (0, t.tZ)('meta', { property: 'og:site_name', content: i().title }),
              ...
              (0, t.tZ)('meta', { name: 'twitter:site', content: i().twitter }),
              ...
              (0, t.tZ)('link', {
                rel: 'canonical',
                href: E || ''.concat(i().siteUrl).concat(c.asPath),
              }),
            ],
          })
        },
        E = function (u) {
          var D = u.title,
            F = u.description,
            e = i().siteUrl + i().socialBanner,
            r = i().siteUrl + i().socialBanner
          return (0, t.tZ)(C, {
            title: D,
            description: F,
            ogType: 'website',
        ...
        c = function (u) {
          var D = u.title,
            F = u.description,
            e = i().siteUrl + i().socialBanner,
            a = i().siteUrl + i().socialBanner,
            E = (0, n.useRouter)()
          return (0, t.BX)(t.HY, {
            children: [
              (0, t.tZ)(C, { title: D, description: F, ogType: 'website', ogImage: e, twImage: a }),
              (0, t.tZ)(r(), {
                children: (0, t.tZ)('link', {
                  rel: 'alternate',
                  type: 'application/rss+xml',
                  title: ''.concat(F, ' - RSS feed'),
                  href: ''.concat(i().siteUrl).concat(E.asPath, '/feed.xml'),
                }),
              }),
            ],
          })
        ...
        A = function (u) {
          var D = u.authorDetails,
            ...
            A = void 0 === c ? [] : c,
            o = u.canonicalUrl,
            l = new Date(n).toISOString(),
            s = new Date(a || n).toISOString(),
            B = (0 === A.length ? [i().socialBanner] : 'string' === typeof A ? [A] : A).map(
              function (u) {
                return { '@type': 'ImageObject', url: ''.concat(i().siteUrl).concat(u) }
              }
            ),
            d = {
              ...
              publisher: {
                '@type': 'Organization',
                name: i().author,
                logo: { '@type': 'ImageObject', url: ''.concat(i().siteUrl).concat(i().siteLogo) },
              },
              description: e,
            },
            m = B[0].url
          return (0, t.BX)(t.HY, {
            children: [
              ...
              (0, t.BX)(r(), {
                children: [
                  n && (0, t.tZ)('meta', { property: 'article:published_time', content: l }),
                  a && (0, t.tZ)('meta', { property: 'article:modified_time', content: s }),
                  (0, t.tZ)('script', {
